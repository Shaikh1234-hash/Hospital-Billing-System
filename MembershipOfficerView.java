/*  <h2> <b>membership officer view </b> </h2>
<p>
*@a program will provide the view of membership model
*@importing awt,swing librarise for view
*@creating constructor to initialize the values
*@calling the super method to give the title
*@creating a class "thehandeler" for action performed
*@calling actionPerformed method to view
*@calling showMessageDialog method to display
