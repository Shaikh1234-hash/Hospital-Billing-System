/*  <h2> <b>membership officer model</b> </h2>
<p>
*@a program will provide the functionalities of membership offier
*@creating  a method for determine the membership type,permium membership,and regular membership
*@creating  two methods for discounting to member,DiscountAmountPremium,DiscountAmountRegular
*@applying setter-getter methods to access private variable
*@all methods are calling in getmembership() method
</p>
