...
class Pharmacy
{
    ...
    void med_list()
    {
        System.out.println(medicines + "\t\t" + med_cost);
    }
}
...
public class HospitalBillingSystem
{
    ...
    public static void main(String args[])
    {
        ...
        pharmacy[] l = new pharmacy [20];
        medicines[] f = new medicines[20];
        ...
        while (status == 1)
        {
            System.out.println("\n                                    MAIN MENU");
            System.out.println("-----------------------------------------------------------------------------------");
            System.out.println("1.Doctos  2. Patients  3.Inventory  4.Pharmacy 5. Staff ");
            System.out.println("-----------------------------------------------------------------------------------");
